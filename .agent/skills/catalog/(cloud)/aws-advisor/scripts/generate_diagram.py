...
def generate_diagram(text: str, diagram_type: str | None = None, title: str | None = None) -> str:
...
def generate_custom(components: list, connections: list, title: str | None = None) -> str:
...
def main():
    ...
    text = sys.stdin.read().strip() if not sys.stdin.isatty() else "serverless api with lambda and dynamodb"
